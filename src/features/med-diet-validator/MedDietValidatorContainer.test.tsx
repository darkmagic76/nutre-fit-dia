...
describe('MedDietValidatorContainer', () => {
  ...
  it('renders DailyLogView with entries when todayLog has foods', () => {
    const foods = [
      makeFood({ id: '1', name: 'Pan integral', category: FoodCategory.CEREALS, kcalPer100g: 250, gramsPerRation: 40 }),
      makeFood({ id: '2', name: 'AOVE', category: FoodCategory.OLIVE_OIL, kcalPer100g: 100, gramsPerRation: 15 }),
    ]
    ...
    expect(screen.getByText(/El registro de hoy cumple con los límites diarios/)).toBeInTheDocument()
