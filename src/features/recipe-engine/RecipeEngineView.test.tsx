...
describe('RecipeEngineView', () => {
  ...
  it('renders checkbox and generate button', () => {
    renderPlan(<RecipeEngineView {...defaultProps} />);
  ...
  it('displays valid plan status', () => {
    ...
    renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={validPlan} />);
    const status = screen.getByRole('status');
    expect(status.textContent).toContain('Plan válido');
  });

  it('displays weekly violations for invalid plan', () => {
    renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={invalidPlan} />);
  ...
  it('shows cultural badges for foods with UNESCO metadata', () => {
    ...
    renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={culturalPlan} />);
  ...
  it.each([
    ...
    renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={plan} />);
  ...
  describe('ZeroWasteBadges', () => {
    ...
    it('renders ♻️ badge when isZeroWaste is true', () => {
      renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={buildPlan(zeroWasteFood)} />);
    ...
    it('renders 🥕 badge when isUglyProduce is true', () => {
      renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={buildPlan(uglyProduceFood)} />);
    ...
    it('renders no badges when both flags are false', () => {
      ...
      renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={buildPlan(plainFood)} />);
  ...
  it('does not render cultural badges when food has no metadata', () => {
    ...
    renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={plainPlan} />);
  ...
  describe('kcal display', () => {
    ...
    it('shows — when caloricTarget is null', () => {
      ...
      renderPlan(<RecipeEngineView {...defaultProps} weeklyPlan={plan} caloricTarget={null} />);
