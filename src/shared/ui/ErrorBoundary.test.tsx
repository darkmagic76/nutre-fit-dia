...
describe('ErrorBoundary', () => {
  ...
  it('isolates errors between sibling ErrorBoundary instances', () => {
    ...
    render(
      <div>
        <ErrorBoundary fallback={<ErrorFallback title="Tab A Error" description="Crashed" buttonLabel="Retry" onRetry={vi.fn()} />}>
          <BrokenTab />
        </ErrorBoundary>
        <ErrorBoundary>
          <HealthyTab />
  ...
  it('retry on broken sibling does not affect healthy sibling', async () => {
    ...
    render(
      <div>
        <ErrorBoundary fallback={<ErrorFallback title="Error A" description="Crashed" buttonLabel="Retry A" onRetry={vi.fn()} />}>
          <BrokenTab />
        </ErrorBoundary>
        <ErrorBoundary>
          <p>Tab B</p>
