...
Generated: 2026-07-12 | Updated: 2026-08-18 | Branch: `develop` | Tests: 818 ✅ (80 files) | Lint: 0 | Typecheck: clean | ADRs: 12
...
| Coverage Functions 100% (2026-08-10)                   | ✅     | `storage.ts` excluded (IndexedDB callbacks not testable in jsdom), 816 tests                           |
| NUTS Food Category (2026-08-10)                        | ✅     | 12th category, ≥3/sem ≤1/día, 5 foods, 2 nudge rules, traffic light GREEN, 818 tests                   |
| Delete dead barrels (2026-08-10)                       | ✅     | Removed `@shared/domain`, `@shared/nudge`, `@shared/sustainability` barrels, fixed RecipeEngine import |
| Normalize domain imports (2026-08-10)                  | ✅     | `@shared/domain\|nudge` → `@domain/*` across 39 files, zero broken imports                             |
